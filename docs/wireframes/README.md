...
Tutorial-specific interaction rules are documented in `../TUTORIAL_IMPLEMENTATION_BETA4.md`. Buildings are selectable throughout the tutorial, speed controls are restricted to the requested tutorial action, and restoration resets the simulation and graph-history boundary trackers to the saved snapshot.
